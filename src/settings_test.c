...
void test_settings_init_from_argv() {
  ...
  Settings* settings4 = settings_init_from_argv(argv4, argc4);
  ...
  Settings* settings5 = settings_init_from_argv(argv5, argc5);
  TEST_CHECK(settings5 != NULL);
  TEST_STREQ("en_US", settings5->language);
  TEST_STREQ("system", settings5->source);
  ...
  TEST_STREQ("baz,fish", settings5->hot_words);
